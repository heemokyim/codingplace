...
def transformation_rows(rowlist_input, col_label_list = None,field=1):
    ...
    """
    if field == 0:    # when field is GF2
        one = GF2.one
    if field == 1:    # when field is R or C
        one = 1
...
def transformation(A, col_label_list = None,field=1):
    ...
    M_rows = transformation_rows(rowlist, col_label_list,field=field)
