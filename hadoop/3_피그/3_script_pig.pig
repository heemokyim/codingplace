...
metadata = LOAD '/user/maria_dev/ml-100k/u.item' USING PigStorage('|')
	AS (movieID:int, movieTitle:chararray, releaseDate:chararray, vidioRelase:chararray, imdbLink:chararray);
...
oldestFiveStarMovies = ORDER fiveStarsWithData BY fiveStarMovies::ratingCount;
